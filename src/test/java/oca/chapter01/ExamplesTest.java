...
class ExamplesTest {
    ...
    void exercise01Test() {
        ...
        FileHandler fileHandler = exercise.getFileHandler("logs/TestLog.txt");
        ...
        Assertions.assertTrue(exercise.deleteFile("logs/TestLog.txt"), "Expected deleteFile to return true when log file is deleted successfully");
    }
