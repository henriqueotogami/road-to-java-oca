...
**Capítulo 7 — `oca/chapter07` (`src/main/java`)**
- ✅ Herança de classes com superclasses e subclasses (`extends`)
- ✅ Reutilização de código por meio de herança
- ✅ Classes concretas e abstratas
- ✅ Sobrescrita de métodos com `@Override`
- ✅ Uso de `super` para acesso a membros e construtores da superclasse
- ✅ Encapsulamento e controle de visibilidade com `private`, `protected`, `public` e acesso default
- ✅ Getters, setters e proteção do estado interno dos objetos
- ✅ Imutabilidade e boas práticas de modelagem orientada a objetos
- ✅ Polimorfismo básico aplicado à herança
- ✅ Testes automatizados relacionados à herança, sobrescrita e níveis de acesso

**Repositório e qualidade**
- ✅ Testes por capítulo com JUnit 5 (`chapter01` … `chapter07` no `build.gradle` da raiz)
...
- ✅ Log4j2 fixado na versão **2.25.5** para manter a estabilidade da pipeline de CI e compatibilidade com a análise SonarCloud (issue #43)
...
**Tags (capítulo):** `chapter01`, `chapter02`, `chapter03`, `chapter04`, `chapter05`, `chapter06`, `chapter07`
...
- 2.2 Execução do build principal: `./gradlew clean build` — compila código e executa todos os testes (`test`, `chapter01` … `chapter07`).
...
### 🔎 Hashtags
#Java #OCA #OracleCertification #JavaSE8 #1Z0808 #Certification #Study #Learning #Gradle #JUnit5 #JaCoCo #SonarCloud #SonarQube #CodeQL #GitHubActions #CI #Log4j2 #Chapter03 #Chapter04 #Chapter05 #Chapter06 #Chapter07 #Operators #Methods #MethodOverloading #Inheritance #ClassInheritance #Encapsulation #AccessModifiers #MethodOverriding #ThisKeyword #SuperKeyword #StaticMembers #Enums #JavaArrays #MultidimensionalArrays #ArrayList #Primitives #Wrappers #OpenSource #Backend #CollaborativeStudy
### 🧠 Meta Keywords
```
...
oca chapter01, oca chapter02, oca chapter03, oca chapter04, oca chapter05, oca chapter06, oca chapter07,
...
herança java, inheritance java, class inheritance, encapsulamento java, encapsulation java,
modificadores de acesso, access modifiers, sobrescrita de métodos, method overriding,
this java, super java, static java, métodos java, classes abstratas, abstract classes,
classes concretas, concrete classes, polimorfismo, polymorphism,
