...
/**
 * <br>Exemplo de classe OldDog para ilustrar herança em Java.
 *
...
public class OldDog {
    ...
    public static final Logger logger = org.apache.logging.log4j.LogManager.getLogger(OldDog.class.getName());
